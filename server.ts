...
const followUpAdapters=new Map(['whatsapp','sms','email','voice','web'].map((channel)=>[channel,new LoggingChannelAdapter(channel as 'whatsapp'|'sms'|'email'|'voice'|'web')] as const));
