  ...
  async save(attribution: RevenueRecoveryAttribution): Promise<void> {
    await this.db.query(
      ...
      [
        ...
        attribution.leadId,
        attribution.leakageOpportunityId,
        attribution.leakageType,
        attribution.ownerId ?? null,
        attribution.recoveredAmount,
        attribution.currency,
        attribution.leakageValue,
        attribution.recoveryRate,
        attribution.recoveredAt,
        attribution.recoverySource,
